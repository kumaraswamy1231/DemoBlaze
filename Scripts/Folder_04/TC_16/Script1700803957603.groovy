...
Price_value = WebUI.getText(findTestObject('Object Repository/Page_STORE/td_360'))

Total_value = WebUI.getText(findTestObject('Object Repository/Page_STORE/h3_360'))

WebUI.verifyMatch(Price_value, Total_value, true)
