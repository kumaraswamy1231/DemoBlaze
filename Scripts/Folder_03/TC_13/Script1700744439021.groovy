...
WebUI.verifyElementPresent(findTestObject('Object Repository/Page_STORE/h2_Samsung galaxy s6'), 0)

WebUI.verifyElementPresent(findTestObject('Object Repository/Page_STORE/h3_360 includes tax'), 0)

WebUI.verifyElementPresent(findTestObject('Object Repository/Page_STORE/div_Product descriptionThe Samsung Galaxy S_78e0c2'), 
    0)
