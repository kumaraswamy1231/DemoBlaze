...
WebUI.verifyElementPresent(findTestObject('Object Repository/Page_STORE/img'), 0)

WebUI.verifyElementPresent(findTestObject('Object Repository/Page_STORE/td_Samsung galaxy s6'), 0)

WebUI.verifyElementPresent(findTestObject('Object Repository/Page_STORE/td_360'), 0)

WebUI.verifyElementPresent(findTestObject('Object Repository/Page_STORE/td_Delete'), 0)
