...
WebUI.verifyElementVisible(findTestObject('Object Repository/Page_STORE/div_About Us            We believe performa_662650'))

WebUI.verifyElementVisible(findTestObject('Object Repository/Page_STORE/div_Get in Touch            Address 2390 El_185b64'))

WebUI.verifyElementVisible(findTestObject('Object Repository/Page_STORE/div_PRODUCT STORE'))
